...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    Examples:
        ...
        95
    Note:The currency denomination is a whole number and cannot be sub-divided. This function calculates and returns the maximum value of the new currency after determining the exchange rate plus the spread."""

    # Converte o spread para decimal
    spread_decimal = spread / 100

    # Calcula a taxa de câmbio com o spread
    taxa_real = exchange_rate * (1 + spread_decimal)

    # Calcula quanto da nova moeda pode ser comprado
    valor_convertido = budget / taxa_real

    # Calcula quantas notas inteiras cabem
    notas = int(valor_convertido // denomination)

    # Retorna o valor total em notas
    return notas * denomination
